# REQUIRED CONFIG
BOT_TOKEN = "8464480351:AAH6n01hpQl-0w2ssIaUyOznRKB702gRI8s"  # Get this from @BotFather
...
# Command Management
CMD_SUFFIX = "1"  # Command suffix to distinguish commands, e.g. "1" would make commands like /mirror1
